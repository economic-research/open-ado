...
{title:pdo} - A module to execute dofiles using project functionality

{p 8 16 2}{cmd:pdo}
{cmd:,} 
{cmdab:file:(}{it:string}{cmd:)} [{cmdab:debug} {cmdab:quietly}]

{p 4 4 2}
where

{p 8 16 2}
{it:quietly} supresses output when compiling in debug mode.
